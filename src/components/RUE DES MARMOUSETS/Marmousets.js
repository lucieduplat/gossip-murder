    ...
    tabulateAnswers = () => {
        ...
        if (c1score !== maxscore) {
            for (let i = 0; i < badAnswersTab.length; i++) {
                if (badAnswersTab[i] === "Coiffeur" || badAnswersTab[i] === "Estheticien") {
                    badAnswers += "NON , je n'etais " + badAnswersTab[i] + ". "
                }
                if (badAnswersTab[i] === "Cuisinier" || badAnswersTab[i] === "Traiteur") {
                    badAnswers += "Mon complice n'etait pas " + badAnswersTab[i] + ". "
                }
                if (badAnswersTab[i] === "L'hotel de ville de paris" || badAnswersTab[i] === "La Prefecture de police de Paris") {
            ...
            <div className="marmouset">
                ...
                <div className="questions">
                            <h1 className="titre">LE CRIME LÉGENDAIRE</h1>
                                ...
                                <h2>Je suis un artisan. Vous venez dans mon salon lorsque vous voulez changer d'apparence.</h2 >
                                <br />
                                ...
                                <h2>Mon complice quant a lui vous attire par l'odeur de ses créations.</h2 >
                                <br />
                                ...
                                <h2>Aujourd'hui nos échoppes ainsi que la rue ont éte detruites et ont laissé place a un batiment officiel.</h2>
                                <br />
                              
                                <label>
                                    <input type="radio" name="q3" value="c1"/> L'hopital Part-Dieu
                                </label><br /><label>
                                    <input type="radio" name="q3" value="L'hotel de ville de paris"/> L'hotel de ville de paris
                                </label><br /><label>
                                    <input type="radio" name="q3" value="La Prefecture de police de Paris"/> La Prefecture de police de Paris
                                </label><br />
                ...
                <div id="answer">{this.state.win}{this.state.badAnswers}{this.state.win && <Meurtrier />}</div>
            </div>
        )
    }
}
